...
@interface PMUChangePassViewController ()<UIScrollViewDelegate,UITextFieldDelegate>

@end

@implementation PMUChangePassViewController
...
- (void)viewDidLoad
{
    ...
    NSArray *LabelFontSizeArray = @[@17, @14];
